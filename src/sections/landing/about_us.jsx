    ...
    <div className="relative overflow-hidden">
      ...
      <div className="bg-[#B0E9F9] min-h-screen w-full flex flex-col justify-center p-5">
        <div className="mx-auto flex md:flex-row flex-col justify-center relative py-20">
          ...
          <div className="hidden md:block -ml-2 z-0">
            <div className="h-1/2">
              <img src="/about_us/top.png" className="h-full" />
            </div>
            <div className="h-1/2">
              <img src="/about_us/bottom.png" className="h-full" />
            </div>
          </div>
          <div className="md:hidden flex -mt-3 -ml-1.5 z-0">
            <div className="w-[40%] md:w-1/2 -rotate-[6.5deg] z-10">
              <img src="/about_us/top.png" className="w-full h-full" />
            </div>
            <div className="w-[60%] md:w-1/2">
              <img src="/about_us/bottom.png" className="w-full h-full" />
            </div>
          </div>
