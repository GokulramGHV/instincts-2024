...
export default function AboutSSNSNU({ slide }) {
  return (
    <div
      style={{
        opacity: slide < 2 ? 1 : 0,
        backgroundColor: slide === 0 ? "#FEDE88" : "#9DD764",
      }}
    ...
    >
      ...
      >
        ...
        <p className="text-base md:text-xl xl:text-2xl 2xl:text-[30px] 2xl:leading-[3rem] xl:w-[70%] w-full p-10 xl:px-20 xl:pt-16 font-satoshi">
          ...
          some of the finest academic and research programs, accomplished
          faculty, state-of-the-art facilities, and a residential campus set on
          a sprawling 230 acres of sylvan surroundings in a variety of
          stimulating environments for intellectual development, innovation, and
          personal growth, challenging young minds with dynamic learning
          opportunities and equipping them with the skills, insights, attitudes
          and practical experiences that are necessary to take up leadership
          responsibilities in the society. SSN has always encouraged the
          confluence of youth and revolutionised the technological realms
        </p>
      </div>
      <div
        style={{ opacity: slide }}
      ...
      >
        ...
        <p className="text-base md:text-xl xl:text-2xl 2xl:text-[30px] 2xl:leading-[3rem] xl:w-[70%] w-full p-10 xl:px-20 xl:pt-16 font-satoshi">
          ...
          addressing future challenges. Established by an act of the Tamil Nadu
          Legislative Assembly to promote, conceptualize and bring about a
          paradigm shift through the development of outstanding leadership,
          research, knowledge and ideas for education and allied development
          sectors, the university, with its on-campus research capabilities and
          the mindset to nurture individuals into problem-solvers of tomorrow,
          is staged to become the epicentre of academic rigor and innovation in
          the region.
          <br />
          <br />
          Each undergraduate program at SNUC is designed to help talented
          students become successful, job-ready professionals or world-class
          academicians.
        </p>
      </div>
    </div>
