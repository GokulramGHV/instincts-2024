          ...
          <div className="flex gap-3 sm:gap-5 items-center">
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
              <Link
                href="/events"
                target="_blank"
                className="rounded-full bg-[#0C5AB9] border border-[#2E3192] text-white whitespace-nowrap text-sm sm:text-xl 2xl:text-2xl font-[900] px-16 sm:px-20 2x:px-28 h-12 sm:h-14 2xl:h-16 flex justify-center items-center hover:shadow-xl transition-all duration-200 hover:opacity-90 w-fit mx-auto"
              >
                VIEW EVENTS
              </Link>

              <div
                className={`${londrinaSolid.className} text-black whitespace-nowrap text-lg sm:text-2xl opacity-85 flex justify-center items-center sm:block`}
              >
                Open the event you want to register for and click register
              </div>
            </div>
          </div>
