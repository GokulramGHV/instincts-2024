    ...
    <>
      <div
        ...
        {images.map((image, index) => (
          <div key={image} className={'h-full mr-[1px] sm:absolute snap-center aspect-[900/520] object-cover ' + (currentIndex !== index ? 'inactive-image' : '')} style={{ transition: 'opacity .3s ease-in-out' }}>
            <Image
              src={image}
              layout="fill"
              objectFit="cover"
